...
def process_files(file_chunk, output_directory, text_key, session_factory, global_index_start):
...
def save_parquet_to_jsonl(dataset_directory: str, output_directory: str, text_key: str, session_factory, workers: int):
    ...
    with ThreadPoolExecutor(max_workers=workers) as executor:
        ...
        for i, file_chunk in enumerate(file_chunks):
            ...
            futures.append(executor.submit(process_files, file_chunk, output_directory, text_key, session_factory, global_index_start))
