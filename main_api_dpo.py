...
from convert.jsonl_dpo import save_jsonl_to_jsonl
#from sft_convert.parquet import save_parquet_to_jsonl
...
async def text_logging(item: Import_Text_Item):
    ...
    try:
        ...
        # md_bash_path = settings.export.base_path
...
if __name__ == "__main__":
    main()
    uvicorn.run(app='main_api_dpo:app', host=settings.server.host, port=22337,
