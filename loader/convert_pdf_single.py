...
def paper_single_process(filepath, output):
    parser = argparse.ArgumentParser()
    #parser.add_argument("filename", help="PDF file to parse")
    #parser.add_argument("filepath", help="PDF file to parse")
    ...
    start = time.time()
    full_text, images, out_meta = convert_single_pdf(filepath, model_lst, max_pages=args.max_pages, langs=langs, batch_multiplier=args.batch_multiplier, start_page=args.start_page, ocr_all_pages=args.ocr_all_pages)
    ...
    #filepath = "/mnt/data/ML_folder/test/ Accumulation of Traffic-Related Trace Metals in Urban Winter-Long Roadside Snowbanks .pdf"
    #output = "/mnt/data/ML_folder/test"
    #paper_single_process(filepath, output)
